...
const FROM = process.env.EMAIL_FROM || 'HOS Pilot - AI-Driven Truck Driver Schedule Optimizer <noreply@example.com>';
const APP_NAME = 'HOS Pilot - AI-Driven Truck Driver Schedule Optimizer';
