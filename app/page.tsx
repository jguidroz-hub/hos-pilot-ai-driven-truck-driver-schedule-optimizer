  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">HOS Pilot - AI-Driven Truck Driver Schedule Optimizer</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Automates and optimizes complex truck driver schedules (sleeper berth splits, time zones) to ensure strict Hours of Service (HOS) compliance, reduce violations, and improve driver well-being and operational efficiency for logistics companies.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust HOS Pilot - AI-Driven Truck Driver Schedule Optimizer.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} HOS Pilot - AI-Driven Truck Driver Schedule Optimizer. All rights reserved.</p>
